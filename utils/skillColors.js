// Map technologies to their skill category colors
const techToColorMap = {
  // Frontend Development - Cyan
  'React': '#06B6D4',
  'Vue.js': '#06B6D4',
  'Vue': '#06B6D4',
  'Nuxt': '#06B6D4',
...
export function getTechColor(techName) {
  return techToColorMap[techName] || '#6B7280' // Default gray if not found
}
