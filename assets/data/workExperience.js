export default [
  {
    ...
    responsibilities: [
      'Gathering requirements from stakeholders and defining project roadmaps',
      'Creating user stories to maximize value within fixed timelines',
      'Building and maintaining web applications using Nuxt, Vue, and Laravel',
      'Implementing scalable architecture to handle tens of thousands of concurrent users',
      'Working with AWS, DynamoDB, GraphQL, and MySQL',
      'Managing white-label deployment processes',
      'Utilizing AI tools to improve development efficiency'
    ],
    technologies: ['Nuxt', 'Vue', 'Laravel', 'MySQL', 'AWS', 'DynamoDB', 'GraphQL', 'JavaScript'],
    teamSize: null,
  ...
  },
  {
    ...
    detailedDescription: [
      'At Vass, an SAP consulting firm, I worked on building custom integrations between SAP ERP systems and other enterprise tools. This role required both technical expertise and strong project management skills to deliver complex enterprise solutions.',
      'I conducted business process analysis to identify business objectives and defined project roadmaps and user stories for 3 different clients. This analytical work was crucial to ensuring technical solutions aligned with business needs.',
      'Beyond individual contribution, I managed 3 teams of 6-10 developers each, ensuring projects were completed on-time and within budget. I also implemented custom solutions using Java and JavaScript in SAP, and conducted lunch & learn sessions to train other developers on best practices.'
    ],
    achievements: [
      'Conducted business process analysis for 3 enterprise clients',
      'Managed 3 teams of 6-10 developers to deliver on-time and within budget',
      ...
      'Successfully delivered enterprise integrations for Fortune 500 clients'
    ],
    responsibilities: [
      'Conducting business process analysis to identify objectives',
      'Defining project roadmaps and user stories for multiple clients',
      'Managing development teams of 6-10 engineers',
      'Implementing custom solutions in SAP using Java and JavaScript',
      'Training and mentoring other developers through knowledge sharing sessions',
      'Ensuring on-time and within-budget project delivery'
    ],
    technologies: ['SAP Commerce', 'Java', 'JavaScript', 'SAP ERP'],
    teamSize: '6-10 engineers per team',
